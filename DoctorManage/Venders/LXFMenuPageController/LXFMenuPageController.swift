...
let kOriginColor = UIColor.white
...
class LXFMenuPageController: UIViewController {
    ...
    /// 头部视图颜色
    var headerColor: UIColor = UIColor.red { didSet { updateView() } }
