...
import SwiftyJSON
import Alamofire
class HistoryExamController: UITableViewController {
    var dataSource:[JSON] = []
    var index = 0
    ...
    func setSubviews() {
        let nib1 = UINib(nibName: "HistoryExamCell", bundle: nil)
        self.tableView.register(nib1, forCellReuseIdentifier: "HistoryExamCell")
    ...
    func requestHistoryData(pageindex:Int) {
        ...
        let urlString = "http://"+Ip_port2+"doctor_train/rest/taskexam/queryTeacherHistory.do"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "HistoryExamCell", for: indexPath) as! HistoryExamCell
