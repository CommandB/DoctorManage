//
//  JHMineResourceViewController.swift
//  DoctorManage
//
//  Created by 陈海峰 on 2018/12/1.
...
class JHMineResourceViewController: UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UITableViewDataSource,UITableViewDelegate,subResMineCellDelegate,UIScrollViewDelegate,UIDocumentInteractionControllerDelegate {
    ...
    func addChildViews() {
        ...
        headView.image = UIImage.init(named: "top背景.png")
        ...
        backButton.setImage(UIImage.init(named: "返回.png"), for: .normal)
        ...
        addButton.setImage(UIImage.init(named: "加号.png"), for: .normal)
