...
class Task: NSObject {
    func checkUpdateForAppID(newVersionHandler: @escaping (_ thisVerion: String, _ newVersion: String) -> Void) {
        ...
        Alamofire.request("http://itunes.apple.com/lookup?id=1289216466", method: HTTPMethod.post, parameters: nil, encoding: URLEncoding.default, headers: ["Content-type":"application/x-www-form-urlencoded"]).responseJSON {
